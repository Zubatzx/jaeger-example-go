...
func (c *Client) Get(ctx context.Context, url, endpoint string, headers http.Header) (*http.Response, error) {
	return c.doMethod(ctx, http.MethodGet, url, endpoint, nil, headers)
}

// GetJSON executes http GET request with the given headers and parse the json response body
// into the given data.
// The returned response Body is already closed
func (c *Client) GetJSON(ctx context.Context, url, endpoint string, headers http.Header, data interface{}) (*http.Response, error) {
	return c.doMethodJSON(ctx, http.MethodGet, url, endpoint, nil, headers, data)
}

// GetJSONWithReqBody executes http GET request with the given headers, request body and parse the json response body
// into the given data.
// The returned response Body is already closed
func (c *Client) GetJSONWithReqBody(ctx context.Context, url, endpoint string, headers http.Header, requestBody interface{}, data interface{}) (*http.Response, error) {
	return c.doMethodJSON(ctx, http.MethodGet, url, endpoint, requestBody, headers, data)
}
...
// - io.Reader
func (c *Client) Post(ctx context.Context, url, endpoint string, headers http.Header, body interface{}) (*http.Response, error) {
	return c.doMethod(ctx, http.MethodPost, url, endpoint, body, headers)
}
